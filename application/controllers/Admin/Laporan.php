...
// die;
		// $this->load->view('admin/export/pdf-barang-masuk', $data);
	...
	public function exportBarangkeluar()
	{
		...
		// $this->load->view('admin/export/pdf-barang-keluar', $data);
	...
	public function exportDataBidang()
	{
		...
		$data['barang_keluar'] = $this->LaporanModel->laporan_data_bidang($id_bidang)->result_array();

		// $this->load->view('admin/export/pdf-bidang', $data);
	...
	public function exportDataSupplier()
	{
		...
		$data['data_barang'] = $this->LaporanModel->laporan_data_supplier($id_supplier)->result_array();

		// $this->load->view('admin/export/pdf-supplier', $data);
	...
	public function exportDataPeminjamanAsset()
	{
		...
		$start = $this->input->get('dari');
        $end = $this->input->get('sampai');
		$data['peminjaman_asset'] = $this->LaporanModel->laporan_terima_data_peminjaman_asset($id_asset, $start, $end)->result_array();
	...
	public function exportDataPenerimaanAsset()
	{
		$id_asset = $this->input->get('id_asset');
		$start = $this->input->get('dari');
        $end = $this->input->get('sampai');
		...
		$this->pdf->setPaper('A4', 'landscape');
		$this->pdf->filename = "Laporan Data Peminjaman Asset.pdf";
		$this->pdf->load_view('admin/export/pdf-penerimaan-asset', $data);
	...
	public function exportDataBarang()
	{
		...
		// $this->load->view('admin/export/pdf-data-barang', $data);
	...
	public function exportDataAsset()
	{
		...
		// $this->load->view('admin/export/pdf-asset', $data);
