                ...
                <div class="card-group">
                    ...
                    <div class="card border-right">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium"><?= $total_datapeminjamanasset ?></h2>
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Peminjaman Asset
                                    </h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                                    <span class="opacity-7 text-muted"><i data-feather="arrow-down"></i></span>
                                    ...
                                    <table class="table no-wrap v-middle mb-0">
                                        <thead>
                                            <tr class="border-0">
                                                ...
                                                <th class="border-0 font-14 font-weight-medium text-muted">Nama Supplier
                                                </th>
                                        ...
                                        <tbody>
                                            <?php foreach ($databarangmasuk as $barangmasuk) {?>
                                                <tr>
                                                    ...
                                                    <td class="border-top-0 text-muted px-2 py-4 font-14"><?= $barangmasuk->nama_supplier ?></td>
