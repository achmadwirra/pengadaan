                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="donut-data-barang" class="mt-2" style="height:283px; width:100%;"></div>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-inline text-right">
                                    <li class="list-inline-item">
                                        <h5><i class="fa fa-circle mr-1 text-info"></i>Barang Masuk</h5>
                                    </li>
                                    <li class="list-inline-item">
                                        <h5><i class="fa fa-circle mr-1 text-danger"></i>Barang Keluar</h5>
                                    </li>
                                </ul>
                                <div class="stats ct-charts position-relative" style="height: 315px;"></div>

                                <!-- <div class="barang-masuk"></div> -->
                ...
                <div class="row">
                                    ...
                                    <table class="table no-wrap v-middle mb-0">
                                        <thead>
                                            <tr class="border-0">
                                                ...
                                                <th class="border-0 font-14 font-weight-medium text-muted px-2">Tanggal Masuk
                                                </th>
                                                <th style="text-align: center;" class="border-0 font-14 font-weight-medium text-muted px-2">Jumlah Barang Masuk
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php foreach ($databarangmasuk as $barangmasuk) {?>
                                                <tr>
                                                    <td class="border-0">
                                                        <div class="d-flex no-block align-items-center">
                                                            <div class="">
                                                                <h5 class=""><?= $barangmasuk->nama_barang ?></h5>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="border-top-0 text-muted px-2 py-4 font-14"><?= $barangmasuk->validation_at ?></td>
                                                    <td style="text-align: center;" class="border-top-0 text-muted px-2 py-4 font-14"><?= $barangmasuk->jumlah_barang ?></td>
                                                </tr>
                                            <?php
                                            } ?>
                                        </tbody>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="card">
                            <div class="card-body ">
                                <div class="d-flex align-items-center mb-4">
                                    <h4 class="card-title">Transaksi Terakhir Barang Pending</h4>
                                </div>
                                <div class="table-responsive users">
                                    <table class="table no-wrap v-middle mb-0">
                                        <thead>
                                            <tr class="border-0">
                                                ...
                                                <th class="border-0 font-14 font-weight-medium text-muted px-2">Tanggal Pengajuan Barang
                                                </th>
                                                <th style="text-align: center;" class="border-0 font-14 font-weight-medium text-muted px-2">Jumlah Barang Pending
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php foreach ($databarangpending as $barangmasuk) {?>
                                                <tr>
                                                    <td class="border-0">
                                                        <div class="d-flex no-block align-items-center">
                                                            <div class="">
                                                    ...
                                                    <td class="border-top-0 text-muted px-2 py-4 font-14"><?= $barangmasuk->tanggal_masuk ?></td>
                                                    <td style="text-align: center;" class="border-top-0 text-muted px-2 py-4 font-14"><?= $barangmasuk->jumlah_barang ?></td>
                                                </tr>
                                            <?php
                                            } ?>
