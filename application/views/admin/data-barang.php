                                            ...
                                            <?php
                                                ...
                                                foreach ($databarang as $db) {
                                                    ...
                                                    echo '<tr>
                                                            ...
                                                            <td style="text-align: center;">'.intval($stok).'</td>  
                                                            <td style="text-align: center;">'.intval($stokk).'</td>  
                                                            <td style="text-align: right;">'.number_format($db->harga_barang).'</td>  
                        ...
                        <div class="modal-body">
                            <form action="<?= base_url('data-barang/update') ?>" method="POST" id="form-update">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="kode_barang_update" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="">Nama Barang</label>
                                ...
                                <div class="form-group">
                                    <label for="">Nama Supplier</label>
                                    <select class="form-control mr-sm-2 select2" id="inlineFormCustomSelect" name="id_supplier_update" required>
                                    <?php
                                    $var = $this->db->get('supplier')->result();
